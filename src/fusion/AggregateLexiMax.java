...
public class AggregateLexiMax extends Aggregate_Function {
	...
	/***
	 * Lexicographically compares two vectors (starting from the end to apply the leximax) containing the same number of elements.
	 * For instance, [3,2,1] >_lex [2,2,0]
	 * 				 [4,3,1] >_lex [4,3,0]
	 * 				 [3,3,1] =_lex [3,3,1] 
	...
	public Vector<Float> choosenAggregate(Models mod) {
		...
		// We compute the transpose of the calculated distances in order to have, for each candidate, 
